// Package config provides configuration management utilities for the Galexy X Panel panel,
...
// GetBaseVersion returns the raw embedded release version of the Galexy X Panel panel
...
// GetName returns the name of the Galexy X Panel application.
func GetName() string {
...
func GetLogFolder() string {
	...
	if testing.Testing() {
		return filepath.Join(os.TempDir(), "Galexy X Panel-test-log")
	}
	if runtime.GOOS == "windows" {
