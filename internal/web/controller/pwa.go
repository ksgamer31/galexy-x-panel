...
var pwaAssets = map[string]pwaAsset{
	...
	"icons/Galexy X Panel-16.png":   {path: "dist/icons/Galexy X Panel-16.png", contentType: "image/png"},
	"icons/Galexy X Panel-24.png":   {path: "dist/icons/Galexy X Panel-24.png", contentType: "image/png"},
	"icons/Galexy X Panel-32.png":   {path: "dist/icons/Galexy X Panel-32.png", contentType: "image/png"},
	"icons/Galexy X Panel-64.png":   {path: "dist/icons/Galexy X Panel-64.png", contentType: "image/png"},
	"icons/Galexy X Panel-192.png":  {path: "dist/icons/Galexy X Panel-192.png", contentType: "image/png"},
	"icons/Galexy X Panel-512.png":  {path: "dist/icons/Galexy X Panel-512.png", contentType: "image/png"},
}
