// Package web provides the main web server implementation for the Galexy X Panel panel,
...
import (
	...
	"github.com/mhsanaei/Galexy X Panel/v3/internal/amneziawgnet"
	...
	"github.com/mhsanaei/Galexy X Panel/v3/internal/mtproto"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/tuic"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/util/common"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/util/sys"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/controller"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/job"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/locale"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/middleware"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/network"
	...
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/service/email"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/service/panel"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/service/tgbot"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web/websocket"
...
// Server represents the main web server for the Galexy X Panel panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) start(restartXray bool, startTgBot bool) (err error) {
	...
	controller.SetTestTgFunc(func() error {
		...
		s.tgbotService.SendMsgToTgbotAdmins("✅ Test message from Galexy X Panel")
		return nil
	})
