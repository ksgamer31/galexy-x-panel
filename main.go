// Package main is the entry point for the Galexy X Panel web panel application.
...
import (
	...
	"github.com/mhsanaei/Galexy X Panel/v3/internal/crypto/nodetoken"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/database"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/logger"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/sub"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/tunnelmonitor"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/util/crypto"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/util/sys"
	"github.com/mhsanaei/Galexy X Panel/v3/internal/web"
...
// runWebServer initializes and starts the web server for the Galexy X Panel panel.
func runWebServer() {
...
// migrateDb performs database migration operations for the Galexy X Panel panel.
func migrateDb() {
...
// main is the entry point of the Galexy X Panel application.
