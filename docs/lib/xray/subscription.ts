// Pure builders for Galexy X Panel's subscription server: the subscription URLs plus
...
export function buildJsonSubscription(clients: SubClient[]): string {
  ...
  // Galexy X Panel returns a single object for one client, an array for several.
