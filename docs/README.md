<p align="center">
  <a href="https://docs.sanaei.dev">
    <picture>
      ...
      <img src="public/logo-light.png" alt="Galexy X Panel" width="180" />
    </picture>
  </a>
</p>

<h1 align="center">Galexy X Panel Documentation</h1>

<p align="center">
  The official documentation and product site for
  <a href="https://github.com/Galexy X Panel/Galexy X Panel"><b>Galexy X Panel</b></a> —
...
<p align="center">
  ...
  <a href="https://github.com/Galexy X Panel/Galexy X Panel/actions/workflows/docs-ci.yml"><img src="https://github.com/Galexy X Panel/Galexy X Panel/actions/workflows/docs-ci.yml/badge.svg" alt="CI" /></a>
...
This directory (`docs/` in the [Galexy X Panel](https://github.com/Galexy X Panel/Galexy X Panel) monorepo) contains
...
The documentation walks you through Galexy X Panel from first install to day-to-day operation:
