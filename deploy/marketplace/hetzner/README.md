# Galexy X Panel on Hetzner Cloud

Hetzner Cloud does **not** have a third-party image marketplace the way AWS does.
Ship Galexy X Panel via **cloud-init**: each instance installs non-interactively and
...
Galexy X Panel non-interactively and generates unique per-instance credentials.
...
is essentially a documented cloud-init config plus metadata. To propose Galexy X Panel as
