...
Galexy X Panel is an open-source web control panel for managing Xray-core servers.

- Backend: Go 1.27, module `github.com/mhsanaei/Galexy X Panel/v3`, Gin and GORM.
...
- Linux install: `bash <(curl -Ls https://raw.githubusercontent.com/mhsanaei/Galexy X Panel/master/install.sh)`
...
- Docker image `ghcr.io/mhsanaei/Galexy X Panel`; PostgreSQL profile
